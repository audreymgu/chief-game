export function load({ url }) {
    ...
    if (result === 'fri') {
        ...
        ogImage = 'https://chief-game.vercel.app/img/e-friends_share.jpg';
    } else if (result === 'bos') {
        ...
        ogImage = 'https://chief-game.vercel.app/img/e-boss_share.jpg';
    } else if (result === 'bel') {
        ...
        ogImage = 'https://chief-game.vercel.app/img/e-beloved_share.jpg';
    } else if (result === 'out') {
        ...
        ogImage = 'https://chief-game.vercel.app/img/e-out_share.jpg';
    } else if (result === 'vio') {
        ...
        ogImage = 'https://chief-game.vercel.app/img/e-violence_share.jpg';
    } else if (result === 'pro') {
        ...
        ogImage = 'https://chief-game.vercel.app/img/e-profit_share.jpg';
    } else if (result === 'gre') {
        ...
        ogImage = 'https://chief-game.vercel.app/img/e-thrones_share.jpg';
    } else if (result === 'qui') {
        ...
        ogImage = 'https://chief-game.vercel.app/img/e-quit_share.jpg'; 
    } else {
